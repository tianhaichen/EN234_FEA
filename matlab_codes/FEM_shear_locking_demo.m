...
%          Illustrates phenomenon of shear locking by computing the
%          displacement field in a 2D linear elastic beam and comparing
%          the FEA prediction with the exact result
%
