...
%
  ...
  r = globaltraction(ncoord,ndof,nnode,nelem,ndload,coords,nelnodes,elident,connect,dloads,dofs);
...
%
function r = globaltraction(ncoord,ndof,nnodes,nelem,ndload,coords,nelnodes,elident,connect,dloads,dofs)
